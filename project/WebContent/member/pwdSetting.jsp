	...
	<div id="content">
		...
		<div id="profile">
			...
			<table id="pro_table">
				<tr>
					<td>비밀번호</td>
					<td><input type="password" name="pass" id="passTxt1" placeholder="비밀번호 입력"></td>
				</tr>
				<tr>
					<td>비밀번호 확인</td>
					<td><input type="password" name="pass2" id="passTxt2" placeholder="비밀번호 확인"></td>
				</tr>
			</table>
			<br>
			<div style="color: red" id="text"></div><br>
			<input type="button" name="btn_ok" id="btnSave" value="변경">
		</div>
	</div>
</body>
</html>
