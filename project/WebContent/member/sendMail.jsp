...
<%
   ...
   String form = "<form action='http://localhost:8088/project/RePassword.me' method='post' name='form'>";
   ...
   try {
      ...
      String img = "<input type='image' src=\"cid:image\">";
      content.append(img);
      ...
      DataSource fds = new FileDataSource("C:\\image\\btn_mail_ok.gif");
