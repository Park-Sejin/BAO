...
<%--    <div id="plusArea" style="border: 3px solid blue;">
      <div id="testdiv" style="border: 3px solid black;">
      
         <div id="WriteForm" style="border: 3px solid green; height: 200px; width: 500px;">
<%
      for(int con=0; con<list.size(); con++){
         Wbb=list.get(con);
%>      
      <!-- <div style="width: 400px; height: 100px; border: 3px solid red;" id="ddd"> -->
       <%=Wbb.getContent().replace("\r\n","<br>")%>
      <!-- </div> -->
             <script type="text/javascript">
             var Write1="";
             Write1+="<div style='width: 400px; height: 200px; border:3px solid red' id=TWirte>";
             Write1+=""+'<%=Wbb.getContent().replace("\r\n","<br>")%>'+"";
             Write1+="</div>";
             $("#WriteForm").append(Write1);
             </script>
<%
               }
%>
